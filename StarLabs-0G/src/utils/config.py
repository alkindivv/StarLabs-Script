...
class OthersConfig:
    ...
    FALLBACK_WITHOUT_PROXY: bool
    MAX_PROXY_RETRIES: int
    ...
    def load(cls, path: str = "config.yaml") -> "Config":
        ...
        return cls(
            ...
            OTHERS=OthersConfig(
                ...
                FALLBACK_WITHOUT_PROXY=data["OTHERS"]["FALLBACK_WITHOUT_PROXY"],
                MAX_PROXY_RETRIES=data["OTHERS"]["MAX_PROXY_RETRIES"],
            ),
            PUZZLEMANIA=PuzzlemaniaConfig(
