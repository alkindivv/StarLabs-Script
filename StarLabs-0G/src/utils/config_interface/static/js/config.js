...
function collectFormData() {
  ...
  document.querySelectorAll("[data-config-path]").forEach((element) => {
    ...
    if (element.type === "checkbox") {
      ...
      const tags = Array.from(element.querySelectorAll(".tag-text")).map(
      ...
      const parseFunc =
        element.dataset.type === "float" ? parseFloat : parseInt;
...
function renderConfig(config) {
  ...
  const sections = {
    ...
    swaps: {
      key: "ZERO_EXCHANGE_SWAPS",
      title: "Zero Exchange Swaps",
      icon: "sync",
    },
  ...
  Object.entries(sections).forEach(
    ([sectionId, { key, title, icon }], index) => {
        ...
        if (key === "SETTINGS") {
          ...
          createCard(
            ...
            [
              ...
              {
                key: "WAIT_FOR_TRANSACTION_CONFIRMATION_IN_SECONDS",
                value:
                  config[key]["WAIT_FOR_TRANSACTION_CONFIRMATION_IN_SECONDS"],
              },
            ],
            key
          );
          ...
          createCard(
            ...
            [
              ...
              {
                key: "EXACT_ACCOUNTS_TO_USE",
                value: config[key]["EXACT_ACCOUNTS_TO_USE"],
                isSpaceList: true,
              },
            ],
            key
          ...
          createCard(
            ...
            [
              {
                key: "PAUSE_BETWEEN_ATTEMPTS",
                value: config[key]["PAUSE_BETWEEN_ATTEMPTS"],
              },
              {
                key: "PAUSE_BETWEEN_SWAPS",
                value: config[key]["PAUSE_BETWEEN_SWAPS"],
              },
              {
                key: "RANDOM_PAUSE_BETWEEN_ACCOUNTS",
                value: config[key]["RANDOM_PAUSE_BETWEEN_ACCOUNTS"],
              },
              {
                key: "RANDOM_PAUSE_BETWEEN_ACTIONS",
                value: config[key]["RANDOM_PAUSE_BETWEEN_ACTIONS"],
              },
              {
                key: "RANDOM_INITIALIZATION_PAUSE",
                value: config[key]["RANDOM_INITIALIZATION_PAUSE"],
              },
            ],
            key
          );
          ...
          createCard(
            ...
            [
              {
                key: "SEND_TELEGRAM_LOGS",
                value: config[key]["SEND_TELEGRAM_LOGS"],
              },
              {
                key: "TELEGRAM_BOT_TOKEN",
                value: config[key]["TELEGRAM_BOT_TOKEN"],
              },
              {
                key: "TELEGRAM_USERS_IDS",
                value: config[key]["TELEGRAM_USERS_IDS"],
                isSpaceList: true,
              },
            ],
            key
          ...
          createCard(
            ...
            [
              ...
              {
                key: "NOCAPTCHA_API_KEY",
                value: config[key]["NOCAPTCHA_API_KEY"],
              },
              {
                key: "USE_NOCAPTCHA",
                value: config[key]["USE_NOCAPTCHA"],
                isCheckbox: true,
              },
            ],
            key
          ...
          createCard(
            cardsContainer,
            "Puzzlemania Settings",
            "puzzle-piece",
            [
              {
                key: "USE_REFERRAL_CODE",
                value: config[key]["USE_REFERRAL_CODE"],
                isCheckbox: true,
              },
              {
                key: "INVITES_PER_REFERRAL_CODE",
                value: config[key]["INVITES_PER_REFERRAL_CODE"],
              },
              {
                key: "COLLECT_REFERRAL_CODE",
                value: config[key]["COLLECT_REFERRAL_CODE"],
                isCheckbox: true,
              },
            ],
            key
          ...
          createCard(
            cardsContainer,
            "Zero Exchange Swaps Settings",
            "sync",
            [
              {
                key: "BALANCE_PERCENT_TO_SWAP",
                value: config[key]["BALANCE_PERCENT_TO_SWAP"],
              },
          ...
          createCard(
            ...
            [
              {
                key: "SKIP_FAILED_TASKS",
                value: config[key]["SKIP_FAILED_TASKS"],
                isCheckbox: true,
              },
            ],
            key
          ...
          createCard(
            ...
            [
              {
                key: "SKIP_SSL_VERIFICATION",
                value: config[key]["SKIP_SSL_VERIFICATION"],
                isCheckbox: true,
              },
              {
                key: "USE_PROXY_FOR_RPC",
                value: config[key]["USE_PROXY_FOR_RPC"],
                isCheckbox: true,
              },
            ],
            key
          ...
          createCard(
            cardsContainer,
            "Crusty Swap Settings",
            "gas-pump",
            [
              {
                key: "NETWORKS_TO_REFUEL_FROM",
                value: config[key]["NETWORKS_TO_REFUEL_FROM"],
                isNetworkSelection: true,
              },
              {
                key: "AMOUNT_TO_REFUEL",
                value: config[key]["AMOUNT_TO_REFUEL"],
                isFloat: true,
              },
              {
                key: "MINIMUM_BALANCE_TO_REFUEL",
                value: config[key]["MINIMUM_BALANCE_TO_REFUEL"],
                isFloat: true,
              },
              {
                key: "WAIT_FOR_FUNDS_TO_ARRIVE",
                value: config[key]["WAIT_FOR_FUNDS_TO_ARRIVE"],
                isCheckbox: true,
              },
              { key: "MAX_WAIT_TIME", value: config[key]["MAX_WAIT_TIME"] },
              {
                key: "BRIDGE_ALL",
                value: config[key]["BRIDGE_ALL"],
                isCheckbox: true,
              },
              {
                key: "BRIDGE_ALL_MAX_AMOUNT",
                value: config[key]["BRIDGE_ALL_MAX_AMOUNT"],
                isFloat: true,
              },
            ],
            key
          ...
          if (
            config[key]["withdrawals"] &&
            Array.isArray(config[key]["withdrawals"])
          ) {
            ...
            config[key]["withdrawals"].forEach((withdrawal, index) => {
              ...
              createTextField(
                ...
                "currency",
                withdrawal.currency,
                `${key}.withdrawals[${index}].currency`
              );
              createNetworkSelectionField(
                withdrawalGroup,
                "networks",
                withdrawal.networks,
                `${key}.withdrawals[${index}].networks`
              );
              createTextField(
                withdrawalGroup,
                "min_amount",
                withdrawal.min_amount,
                `${key}.withdrawals[${index}].min_amount`,
                true
              );
              createTextField(
                withdrawalGroup,
                ...
                `${key}.withdrawals[${index}].max_amount`,
                true
              );
              createTextField(
                withdrawalGroup,
                "max_balance",
                withdrawal.max_balance,
                `${key}.withdrawals[${index}].max_balance`,
                true
              );
              createCheckboxField(
                withdrawalGroup,
                "wait_for_funds",
                withdrawal.wait_for_funds,
                `${key}.withdrawals[${index}].wait_for_funds`
              );
              createTextField(
                withdrawalGroup,
                "max_wait_time",
                withdrawal.max_wait_time,
                `${key}.withdrawals[${index}].max_wait_time`
              );
              createTextField(
                withdrawalGroup,
                "retries",
                withdrawal.retries,
                `${key}.withdrawals[${index}].retries`
              );
          ...
          createCard(
            ...
            [
              {
                key: "MAX_PRICE_TO_MINT",
                value: config[key]["OMNIHUB"]["MAX_PRICE_TO_MINT"],
                isFloat: true,
              },
            ],
            `${key}.OMNIHUB`
...
function createCard(container, title, iconClass, fields, category) {
  ...
  fields.forEach(
    ({
      ...
      if (
        isCheckbox ||
        (typeof value === "boolean" && isCheckbox === undefined)
      ) {
...
function createTextField(container, key, value, path, isFloat = false) {
  ...
  if (key.toLowerCase().includes("key")) {
    ...
    tooltip.innerHTML =
      '?<span class="tooltip-text">Enter your API key here</span>';
